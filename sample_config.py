...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "APPIDAPIHASHSCRAPPERBOT")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "APPIDAPIHASHSCRAPPERBOT")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/APPIDAPIHASHSCRAPPERBOT")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/APPIDAPIHASHSCRAPPERBOT"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "😅 @KINGBOTOFFICIAL")
